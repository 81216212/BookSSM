...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/views/js/user/forget.js'/>"></script>
  </head>
...
a {
	...
	<div class="container">
		<div class="register">
			<h2>找回密码</h2>
			<form target="_top" action="forget" method="post" id="forgetForm">
				...
				<input class="inputClass" type="text" name="email" id="email" autocomplete="off" autocomplete="new-password" value="${form.email }" placeholder="邮箱"/>
				<label class="errorClass" id="emailError">${erremail }</label>
				
				<input class="inputClass" type="password" name="loginpass" id="loginpass" autocomplete="new-password" value="${form.loginpass }" placeholder="新密码"/>
				...
				<label class="login"><input type="submit" id="submitBtn" value="找回密码"></label>
		</div>
			</form>
