...
<html>
	...
	<head>
		...
		<script src="<c:url value='/views/js/book/desc.js'/>"></script>
	</head>
	<style>
		#btn {
	...
	$(document).ready(function() {
		$(".goubutton").click(function() {
			var loginname = window.decodeURI("${sessionScope.sessionUser.loginname }");
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 cart-table">
				...
				<span style="display:none;" id="cartmsg">${cartmsg }</span>
					<tr>
					...
					<form id="form1" action="<c:url value='/cart/add?'/>" method="get">
						<tr>
							<td><input type="hidden" name="bid" value="${book.bid }" />
								...
								<a class="goubutton" href="javascript:$('#form1').submit();">加入购物车</a>
							</td>
						</tr>
					</form>
				</table>
